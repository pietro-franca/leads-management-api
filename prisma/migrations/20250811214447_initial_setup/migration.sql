...
-- CreateEnum
CREATE TYPE "public"."LeadCampaignStatus" AS ENUM ('NewEngaged', 'FollowUp_Scheduled', 'Contacted', 'Qualified', 'Converted', 'Unresponsive', 'Disqualified', 'Re_Engaged', 'Opted_Out');
...
CREATE TABLE "public"."LeadCampaign" (
    ...
    "status" "public"."LeadCampaignStatus" NOT NULL,
